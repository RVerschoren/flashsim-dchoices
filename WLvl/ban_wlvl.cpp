 ...
 *
 * Class implementing the Ban wear leveling scheme, which cleans a random block after every tau erasures.
 */
...
enum status WLvlImpl_Ban::insert(const Address &address)
{
