...
enum status
FtlImpl_Dftl::write(Event& event) {
	uint dlpn = event.get_logical_address();
...
void
FtlImpl_Dftl::cleanup_block(Event& event, Block* block)
{
...
void
FtlImpl_Dftl::print_ftl_statistics()
{
