...
enum status
FtlImpl_Page::write(Event& event) {
...
FtlImpl_Page::trim(Event& event) {
	...
	// Update trim map and update block map if all pages are trimmed. i.e. the
	// state are reseted to optimal.
