...
WLvlImpl_CleanMaxValidDCh::WLvlImpl_CleanMaxValidDCh(FtlParent* ftl, const double p, const uint d)
...
enum status WLvlImpl_CleanMaxValidDCh::suggest_WF(Event& /*evt*/, Address& WFSuggestion, Controller& /*controller*/,
