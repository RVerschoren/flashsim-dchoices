...
void
Event::consolidate_metaevent(Event& list)
{
	Event* cur;
	double max;
	double tmp;
...
ssd::ulong
Event::get_logical_address(void) const
{
	return logical_address;
}

void
Event::set_logical_address(const ulong newLPN)
{
	this->logical_address = newLPN;
}

const Address&
Event::get_address(void) const
{
	return address;
}

const Address&
Event::get_merge_address(void) const
{
	return merge_address;
}

const Address&
Event::get_log_address(void) const
{
	return log_address;
}

const Address&
Event::get_replace_address(void) const
{
	return replace_address;
}

void
Event::set_log_address(const Address& address)
{
	log_address = address;
}

ssd::uint
Event::get_size(void) const
{
	return size;
}

enum event_type
Event::get_event_type(void) const {
	return type;
}

void
Event::set_event_type(const enum event_type& type)
{
	this->type = type;
}

double
Event::get_start_time(void) const
{
	assert(start_time >= 0.0);
	return start_time;
}
...
double
Event::get_time_taken(void) const
{
...
double
Event::get_bus_wait_time(void) const
{
...
void
Event::set_payload(void* payload)
{
	this->payload = payload;
}

void*
Event::get_payload(void) const
{
	return payload;
}

void
Event::set_address(const Address& address)
{
...
void
Event::set_merge_address(const Address& address)
{
...
void
Event::set_replace_address(const Address& address)
{
	replace_address = address;
}

void
Event::set_noop(bool value)
{
	noop = value;
}

void
Event::set_next(Event& next)
{
	this->next = &next;
	return;
}
...
double
Event::incr_bus_wait_time(double time_incr)
{
	if (time_incr > 0.0)
...
double
Event::incr_time_taken(double time_incr)
{
	if (time_incr > 0.0)
...
void
Event::set_hot(const bool isHot)
{
	hot = isHot;
}
