...
/*
 * FTL makes use of a Block_manager object
 */
bool FTL_USE_BLOCKMANAGER = FTL_IMPLEMENTATION < 0 and FTL_IMPLEMENTATION < 5;
...
void load_entry(char *name, double value, uint line_number) {
    ...
    else if (!strcmp(name, "GC_FULLVICTIM_STATS"))
        GC_FULLVICTIM_STATS = (value == 1);
    else
...
void print_config(FILE *stream) {
    ...
    fprintf(stream, "GC_FULLVICTIM_STATS: %i\n", GC_FULLVICTIM_STATS);
